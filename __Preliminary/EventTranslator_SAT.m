...
for curCHUNK = 0:multifilenameNo
    ...
    disp (['SAVING TO...', file])
    save(file,'SAT_','Gains_EyeX','Gains_EyeY','Gains_XYF','Gains_YXF','MStim_','TrialStart_','Target_','Errors_','Correct_','Decide_','SaccDir_','Stimuli_','-mat');
...
for curCHUNK= 0:multifilenameNo
    ...
    temp = load (file,'SAT_','Gains_EyeX','Gains_EyeY','Gains_XYF','Gains_YXF','MStim_','TrialStart_','Target_','Errors_','Correct_','Decide_','SaccDir_','Stimuli_','-mat');
...
save([file_path,outfile],'SAT_','Gains_EyeX','Gains_EyeY','Gains_XYF','Gains_YXF','MStim_','TrialStart_','Target_','Errors_','Correct_','Decide_','SaccDir_','Stimuli_','-mat')
