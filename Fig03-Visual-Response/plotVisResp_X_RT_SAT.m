function [ ] = plotVisResp_X_RT_SAT( binfo , moves , ninfo , spikes , varargin )
%plotVisResp_X_RT_SAT Summary of this function goes here
...
for cc = 1:NUM_CELLS
  ...
  spkCtCC = cellfun(@(x) sum((x > T_VISRESP(1)) & (x < T_VISRESP(2))), spikes(cc).SAT);
