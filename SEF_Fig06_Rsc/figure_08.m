...
rscTable.nTrials = spkCorr.nTrials; % TR 06/22/2020
...
outSpkCorr.nTrials = rscTable.nTrials; % TR 06/22/2020
...
MIN_NUM_TRIAL = 5;
outSpkCorr(outSpkCorr.nTrials < MIN_NUM_TRIAL, :) = []; % TR 06/22/2020
