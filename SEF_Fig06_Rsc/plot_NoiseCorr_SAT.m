%plot_NoiseCorr_SAT.m

kk = 2; %index struct rNoise
...
% ppretty([2.4,2.2*nPair])
ppretty([2.4,24])

% clearvars -except ROOTDIR* behavData unitData pairData rNoise scNoise
